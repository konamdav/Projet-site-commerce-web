...
<script type="text/javascript" src="scripts/consoles.js"></script>
</head>
...
<%
	...
	<jsp:include page="menu-account.jsp">
		<jsp:param name="curr" value="CONSOLES" />
	</jsp:include>
	...
	<div class="row">
		...
		<div class="col-6">
			...
			<form id="create" action="" method="post" onsubmit="return submitCreateConsole();">
			...
			<form id="update" action="" method="post" onsubmit="return submitUpdateConsole();">
				<div style="width: 19%; display: inline-block;">Console :</div>
				<input style="width: 80%" id="name" name="name" type="text">
				<br><br>
				<button type="submit" class="btn btn-primary">Modifier</button>
				<input type="hidden" name="id_console" id="id_console"/>
			</form>
